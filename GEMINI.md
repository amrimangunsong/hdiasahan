...
- **Backend:** Supabase handles the database (PostgreSQL) and provides a client-side SDK for data fetching.
...
- **Data Management:** Most data (products, certificates, etc.) should be stored in Supabase tables. Use the `src/lib/supabase.ts` client for all database interactions.
